...
console.log('Script ini dibuat oleh: kikyy | IG: @kky_krnwn331');
console.log('Lihat Script HTML Lainnya di https://kkykrnwn.github.io/mypacar');
...
hrf.href = 'https://kkykrnwn.github.io/mypacar/file/utama.html';
...
document.getElementById("loveIn").onclick = function() {
  ...
  async function aksibalas(){await swals.fire('OK!', 'Kirim pesan ke WA aku, ya!', 'success');window.location = "https://wa.me/6285603209755?text=" + pesanwhatsapp;Tombol.style="opacity:1;transform: scale(1)";}
